...
const username: string = firstName.value + lastName.value;
    ...
    return (
      ...
      <TextInput label="Email" placeholder="Your email" id="email" required mt="md" {...email} />
      <PasswordInput label="Password" placeholder="Your password" id="password" required mt="md" {...password} />
      <PasswordInput label="Confirm Password" placeholder="Your password" id="confirm_password" required mt="md" {...confirmPassword} />
