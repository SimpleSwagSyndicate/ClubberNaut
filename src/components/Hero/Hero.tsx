                  ...
                  {content.map((c: any, index) => (
                    <div key={index}>
                      <Paper
                        ...
                        radius={50}
                      >
                        <text className={classes.club}> {c.club} </text>
                        <br />
                        <br />
                        <text className={classes.content}> {c.date} </text>
                        <br />
                        <text className={classes.content}> {c.title} </text>
                        <br />
                        <br />
                        <text className={classes.content}> {c.description} </text>
                      </Paper>
                      <Space h="md" />
                    </div>
                  ))}
